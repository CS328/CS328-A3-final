...
n_features = 2040 # 20 formant features + 16 pitch contour features + 75 mfcc delta coefficients
...
best_classifier = RandomForestClassifier(n_estimators=100) # change this to the classifier (tested above) that gives the best results
